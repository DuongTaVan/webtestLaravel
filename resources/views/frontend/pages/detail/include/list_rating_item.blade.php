    ...
    @foreach($ratings as $rating)
        <div class="itemm">
            <p class="item_author">
                ...
                <span class="item_success"><i
                        class="fas fa-check-circle"></i> Đã mua hàng tại DuongGA</span>
            </p>
            ...
            <div class="item_footer">
                    <span class="item_time"><i
                            class="fa fa-clock-o"></i> đánh giá {{$rating->created_at}}</span>
            </div>
        </div>
    @endforeach
