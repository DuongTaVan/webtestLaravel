                            ...
                            <div class="box-body">
                                <div class="form-group">
                                    ...
                                    <input name="cp_name" class="form-control" id="exampleInputEmail1"
                                           value="{{$coupon->cp_name}}"
                                           placeholder="coupon name ...">
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputPassword1">Code</label>
                                    <input name="cp_code" class="form-control" value="{{$coupon->cp_code}}"
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="cp_type">
                                        <option value="0" @if($coupon->cp_type==0) selected @endif>Giảm theo %</option>
                                        <option value="1" @if($coupon->cp_type==1) selected @endif>Giảm theo tiền</option>
                                    </select>
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputPassword1">Number</label>
                                    <input name="cp_number" class="form-control" id="exampleInputPassword1"
                                           value="{{$coupon->cp_number}}"
